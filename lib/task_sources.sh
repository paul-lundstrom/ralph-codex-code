...
#   1 - Error
#
# Note: For full PRD conversion with Codex, use ralph-import
...
# convert_prd_with_codex - Full PRD conversion using Codex (calls ralph-import logic)
#
# Parameters:
#   $1 (prd_file) - Path to the PRD file
...
export -f convert_prd_with_codex
